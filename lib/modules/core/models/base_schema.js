...
/**
 * Before a new instance can be saved,
 * Check each unique field and invalidate if a doc with that field exists
 */
...
/**
 * Checks if there is a doc with a given key and value.
 * If there is it creates a 'non-unique' error message.
 *
 * @param {Object} Obj - Object with the fieldName and value from the new doc
